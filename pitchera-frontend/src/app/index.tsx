...
export default function HomePage() {
  const handleGetStarted = () => {
    // Change this route to your actual login/sign-up route.
    // Google must be able to access this homepage without authentication.
    if (Platform.OS === "web") {
      window.location.href = "/login";
    } else {
      Linking.openURL("https://pitchera.netlify.app/login");
    }
  };
    ...
    >
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerLinks}>
          ...
          <Pressable style={styles.signInButton} onPress={handleGetStarted}>
      ...
      <View style={styles.hero}>
        <View style={styles.badge}>
          <Text style={styles.badgeText}>JOB SEARCH & APPLICATION PLATFORM</Text>
        </View>
        ...
        <Text style={styles.heroDescription}>
          ...
          resumes, job applications, and personalized job application emails
          from one place.
        </Text>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.sectionDescription}>
          Pitchera is a platform designed for job seekers who want a simpler
          way to organize their professional information and manage their job
          applications.
        </Text>
      </View>
      ...
      <View style={styles.gmailSection}>
        ...
        <View style={styles.gmailContent}>
          ...
          <Text style={styles.gmailDescription}>
            ...
            authorize Gmail access. This allows you to send personalized job
            application emails using your connected Gmail account.
          </Text>
